    ...
    <div className="w-screen min-h-min flex flex-col justify-center items-center p-4 overflow-x-hidden overflow-y-hidden relative z-10">
      ...
      >
        ...
        <p className="text-md md:text-lg px-4 py-2 max-w-[100vw] md:max-w-[40vw]">
          On the search for Internship and Junior Roles in Full-Stack/Backend
          Web Development, Machine Learning and Database Management. Open to any
          technical opportunities with a love of learning how systems operate!
        </p>
